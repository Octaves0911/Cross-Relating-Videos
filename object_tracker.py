...
def MSE(image1, image2):
    ...
    err = err / (image1.shape[0]*image1.shape[1])
    return err
...
def main(_argv):
    ...
    while True:
        ...
        # if enable info flag then print details about each track
            center_coordinates = (int((bbox[0]+ bbox[2])/2),int((bbox[1]+bbox[3])/2))
            print(center_coordinates)
            if(class_name == 'person' and center_coordinates[0] in range(120, 476) and center_coordinates[1] in range(191,979)):
                # adding the ocr
                ...
                if (flag == 1 ):
                    ...
                    time_stamp.append(time_frame1)
                    print("the time difference is ", (time_ev_vid2 - time_ev_vid1).seconds)
                    flag = 2
                    break
        ...
        if not FLAGS.dont_show:
            cv2.imshow("Output Video", np.concatenate((result1, result), axis = 1))
        if (flag == 2):
            print("the time difference is ", (time_ev_vid2 - time_ev_vid1).seconds)
    ...
    time_diction = {"Event 1 Occured at ": time_ev1,
